...
public class MySql {
	 ...
	 // JDBC driver name and database URL
	   ...
	   static final String DB_URL = "jdbc:mysql://localhost/dhanya?autoReconnect=true&useSSL=false";
	...
	public static void main(String[] args) {
	   ...
	   try{
	      ...
	      statement.setString(2, "dhanya");
	      statement.setString(3, "dhanya123@gmail.com");
	      statement.setInt(4, 1313142861);
	      statement.setString(5, "mangalore");
